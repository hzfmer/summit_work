...
print "average stress drop: %e" % sd[0:zi1-tpw_b,xi0+tpw_h:xi1-tpw_h].mean()
...
if 1:
  ...
  plot (-yy*mu_s[:,xis]+coh, dpt, label='static shear strength')
  plot (-yy*mu_d[:,xis]+coh, dpt, label='dynamic shear strength')
...
fid=open("plast_M6.8_z0_G_lvz2.dat", "w")
yi=150
yz=0.
