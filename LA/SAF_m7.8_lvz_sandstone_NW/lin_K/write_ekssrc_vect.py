...
output_u = open(os.path.join(os.getcwd().replace('_D', '_d')
              , "output_dyn/ratu").replace('lin','eks')
              .replace('sandstone', rock)
              ,'wb')
output_w = open(os.path.join(os.getcwd().replace('_D', '_d')
