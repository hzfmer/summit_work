...
*  NZ           eINTEGER>     -Z              z model dimension in nodes                                       *
             ...
             int *NGRIDS, int *FOLLOWBATHY)
{
   ...
   *FOLLOWBATHY = def_FOLLOWBATHY;
    ...
    extern char *optarg;
    static const char *optstring = "-T:H:t:A:P:M:D:S:N:V:B:n:I:R:Q:X:Y:Z:x:y:G:z:i:l:h:30:p:s:r:W:1:2:3:11:12:13:21:22:23:100:101:102:o:c:";
    ...
    while ((c=getopt_long(argc, argv, optstring, long_options, NULL)) != -1)
    {
        switch (c) {
            ...
            case 'S':
                parsemultiple(optarg, NSRC); break;
            case 'N':
            ...
            case 'Z':
                parsemultiple(optarg, NZ); break;
            case 'x':
                *PX         = atoi(optarg); break;
            case 'y':
                *PY         = atoi(optarg); break;
            case 1:
                parsemultiple(optarg, NBGX); break;
            case 2:
                parsemultiple(optarg, NEDX); break;
            case 3:
                parsemultiple(optarg, NSKPX); break;
            case 11:
                parsemultiple(optarg, NBGY); break;
            case 12:
                parsemultiple(optarg, NEDY); break;
            case 13:
                parsemultiple(optarg, NSKPY); break;
            case 21:
                parsemultiple(optarg, NBGZ); break;
            case 22:
                parsemultiple(optarg, NEDZ); break;
            case 23:
                parsemultiple(optarg, NSKPZ); break;
            case 'i':
    ...
    /* if a \ character is present in the command-line arguments, it is interpreted as 1
       and NBGX[0] is set to 0.  This line prevents that. */
