...
#            aspect=9)
#cb.set_label('Vs (m/s)')
fig.savefig('vs_het_perpend_TKCH05_h005l100_std10_sm.svg', dpi=600, bbox_inches='tight',
            pad_inches=0.1)
...
#ax[0].set_ylabel('Depth (km)')
#cb.set_label('Vs (m/s)')
fig.savefig('vs_het_horizon_TKCH05_h005l100_std10_sm.svg', dpi=600, bbox_inches='tight', pad_inches=0.1)
