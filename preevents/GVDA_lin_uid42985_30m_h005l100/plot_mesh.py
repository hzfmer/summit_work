...
cax1 = ax.imshow(np.squeeze(vs[site_x,:,:]).T, cmap=cmap,
...
#            aspect=9)
#cb.set_label('Vs (m/s)')
fig.savefig('vs_het_perpend_GVDA_h005l100.svg', dpi=600, bbox_inches='tight',
            pad_inches=0.1)
...
ax.set_ylabel('Depth (km)')
ax.set_aspect(2)
fig.savefig('vs_het_horizon_GVDA_h005l100.svg', dpi=600, bbox_inches='tight', pad_inches=0.1)
#fig, ax = plt.subplots(figsize=(6.5, 4.7)) 
#plt.subplots_adjust(left=0.1, right=0.9, hspace=0.5)
...
#ax.set_ylabel('Depth (km)')
#ax.set_aspect(2)
#fig.savefig('vs_het_perpend_GVDA_rec3_h005l100.svg', dpi=600, bbox_inches='tight',
#            pad_inches=0.1)
