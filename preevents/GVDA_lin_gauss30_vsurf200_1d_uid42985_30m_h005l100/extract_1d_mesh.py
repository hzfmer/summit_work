...
np.savetxt('mesh_gvda_4m_gauss30_vsurf200_1d.txt', np.hstack([vp, vs, ro, qp, qs]), fmt='%f')
nxx = 80
nyy = 80
site_xx = 40
site_yy = 41
...
dat.tofile('mesh_gvda_4m_gauss30_vsurf200_1d.bin')
...
ax.set_aspect(2)
fig.savefig('vs_perpend_GVDA_gauss30_vsurf200_1d.svg', dpi=600, bbox_inches='tight',
                        pad_inches=0.1)
...
ax.set_ylabel('Depth (km)')
ax.set_aspect(2)
fig.savefig('vs_horizon_GVDA_gauss30_vsurf200_1d.svg', dpi=600, bbox_inches='tight', pad_inches=0.1)
