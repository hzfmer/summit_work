...
#            aspect=9)
#cb.set_label('Vs (m/s)')
fig.savefig('vs_het_perpend_smth_per_GVDA_h005l100.svg', dpi=600, bbox_inches='tight',
            pad_inches=0.1)
...
ax.set_ylabel('Depth (km)')
ax.set_aspect(2)
fig.savefig('vs_het_perpend_smth_per_GVDA_rec3_h005l100.svg', dpi=600, bbox_inches='tight',
            pad_inches=0.1)
...
#ax[0].set_ylabel('Depth (km)')
#cb.set_label('Vs (m/s)')
fig.savefig('vs_het_horizon_smth_per_GVDA_h005l100.svg', dpi=600, bbox_inches='tight', pad_inches=0.1)
