...
#            aspect=9)
#cb.set_label('Vs (m/s)')
fig.savefig('vs_perpend_nohet_TKCH05_h005l100.svg', dpi=600, bbox_inches='tight',
            pad_inches=0.1)
...
#ax[0].set_ylabel('Depth (km)')
#cb.set_label('Vs (m/s)')
fig.savefig('vs_horizon_nohet_TKCH05_h005l100.svg', dpi=600, bbox_inches='tight', pad_inches=0.1)
