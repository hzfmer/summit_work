...
fig.show()
fig.savefig(os.path.join(res_dir,'vs_perpend_orig_TKCH05.png'), dpi=600,
...
#ax[0].set_ylabel('Depth (km)')
fig.show()
fig.savefig(os.path.join(res_dir,'vs_horizon_orig_TKCH05.png'), dpi=600,
                    bbox_inches='tight', pad_inches=0.1)
...
for ii in range(10):
    ...
    dat.tofile(os.path.join(data_dir,f'mesh_TKCH05_081318_{ii}.bin'))
...
fig.show()
fig.savefig(os.path.join(res_dir,'MRVBF_TKCH05.png'), dpi=600,
                    bbox_inches='tight', pad_inches=0.1)
...
fig.savefig(os.path.join(res_dir,'MRVBF_bd_TKCH05.png'), dpi=600,
                    bbox_inches='tight', pad_inches=0.1)
...
fig.show()
fig.savefig(os.path.join(res_dir,'bed_depth_TKCH05.png'), dpi=600,
                    bbox_inches='tight', pad_inches=0.1)
...
#ax[0].set_ylabel('Depth (km)')
fig.show()
fig.savefig(os.path.join(res_dir,'vs_perpend_TKCH05.png'), dpi=600,
                    bbox_inches='tight', pad_inches=0.1)
...
#ax[0].set_ylabel('Depth (km)')
fig.show()
fig.savefig(os.path.join(res_dir,'vs_horizon_TKCH05.png'), dpi=600,
                    bbox_inches='tight', pad_inches=0.1)
