...
program add
  ...
  integer(kind=8), parameter    :: nx = 3240, ny = 5355
  !integer(kind=8), parameter    :: nz_ssh = 36, nz_tap = 24
  integer(kind=8), parameter    :: nz_ssh = 26, nz_tap = 14
  ...
  real                          :: tapval
  real, parameter               :: vpmax = 9320, vsmax = 6590.
  integer                       :: comm_fr
  integer                       :: color
  
  filename_fr = 'ssh_66m_p1.out'
  filename_hom = 'casc+vanc12km_ext_dh200_p1.odc'
  filename_het = 'casc+vanc12km_ext_dh200_het_p1.odc'
