...
program add
  ...
  integer(kind=8), parameter    :: nx = 400, ny = 400
...
!  real, parameter               :: vpmax = 5701, vsmax = 3300., vsmin=140
  real, parameter               :: vpmax = 3501, vsmax = 1700., vsmin=140
  
  filename_fr = 'ssh_2.5m_h005l100.out'
  filename_hom = 'mesh_TKCH05_052119_2v680_bd98.bin'
  filename_het = 'mesh_TKCH05_het_052119_2v680_bd98_h005l100.bin'
