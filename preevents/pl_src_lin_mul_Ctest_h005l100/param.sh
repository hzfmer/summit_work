  ...
  --TMAX 5.00   --DH 2.5 --DT 0.0002 
  --ND 20 --ARBC 0.95 --NPC 2
  --NSRC 1 --NST 25000 --READ_STEP 25000
  --IFAULT 6 --INSRC stf_C.txt  
  --INVEL mesh --MEDIASTART 2 
  --IDYNA 0  --NVE 1 --NVAR 5 
  --NBGX 51 --NEDX 351 --NSKPX 50 --NBGY 201 --NEDY 201 
  --NBGZ 1 --NEDZ 1 --OUT output_sfc 
  --NTISKP 25 --WRITE_STEP 1000 
