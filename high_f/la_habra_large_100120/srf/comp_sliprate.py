...
mx, my = 6480, 4968
mz = 250  # 250*24 = 6km > (4.5 + 2.5) - 1.216
block_top = 1.216
xoff_0, xoff_1 = 2700, 3700
yoff_0, yoff_1 = 1300, 2300
kx, ky = xoff_1 - xoff_0, yoff_1 - yoff_0

try:
    kdtree = pickle.loads(Path('kdtree.pickle').read_bytes())
except:
    grids = np.fromfile('../surf_center.grid', dtype='float64').reshape(my, mx, 3)
...
with open('../mesh_large_8m_orig.bin_1', 'rb') as f_media:
    for i in range(mz):
        try:
