...
for dhyp, seed in zip([1,1], [1848640878, 387100462]):
    for case in ['q100f00_orig', 'topo_q100f00_orig', 'q100f00_s05h005l100', 'topo_q100f06_s05h005l100']:
    #for case in ['q100f00_orig', 'q100f00_s05h005l100']:
...
os.chdir('/ccs/home/hzfmer/scratch/high_f/la_habra_small_8m_gpu_dm_abc50/results8')
