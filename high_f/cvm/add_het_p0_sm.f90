...
program add
  ...
  integer(kind=8), parameter    :: nx = 1400, ny = 1400, nz = 500
  ...
  real, parameter               :: vpmax = 7632.22, vsmax = 4622., vsmin=100   
  
  filename_fr = 'ssh_20m_sm.out'
  filename_hom = 'lahabra_small_mesh_cvmsi_ijk12_20m.media'
  filename_het = 'lahabra_small_mesh_cvmsi_ijk12_het_20m.media'
