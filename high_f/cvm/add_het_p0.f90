...
program add
  ...
  integer(kind=8), parameter    :: nx = 9000, ny = 6750, nz = 500
  ...
  real, parameter               :: vpmax = 7564, vsmax = 4590.2, vsmin=61    
  
  filename_fr = 'ssh_20m_dm.out'
  filename_hom = 'la_habra_large_cvmsi_20m.media'
  filename_het = 'la_habra_large_cvmsi_het_20m.media'
