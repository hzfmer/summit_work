...
int main (int argc, char *argv[] ) {
   ...
   int nx=9000, ny=6750, nz=2700, k0=372;
   int nvar=3;
   int skip=3;
   //char *infile="la_habra_large_cvmsi_het_20m.media";
   //char *outfile="la_habra_large_cvmsi_het_20m_p1.media";
   char *infile="la_habra_large_cvmsi_20m.media";
   char *outfile="la_habra_large_cvmsi_20m_p1.media";
